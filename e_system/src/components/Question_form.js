                        ...
                        {!ques.answer ? (<AccordionDetails className="add_question" >
                          ...
                          <div >
                              ...
                              {ques.options.map((op, j)=>(
                                 ...
                                 <Button size="small"  onClick={()=>{addAnswer(i)}} style={{textTransform: 'none',color:"#4285f4",fontSize:"13px",fontWeight:"600"}}>       <FcRightUp style={{border:"2px solid #4285f4", padding:"2px",marginRight:"8px"}} /> Respuesta </Button>
